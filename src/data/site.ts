export const site = {
  ...
  tagline: 'AI & Machine Learning | Indiana Wesleyan University',
  email: 'onmay16@gmail.com',
  github: 'https://github.com/onmay16',
  linkedin: '',
...
As I progress through the AIML program, I am developing the habits of a lifelong learner: asking clear questions, documenting my process, and sharing work that others can learn from.`,
  valueProposition: {
    headline:
      'I bridge production software engineering with AI/ML practice to deliver solutions that are rigorous, explainable, and ready for real stakeholders.',
    bullets: [
      {
      ...
      },
      {
        ...
        text: 'I design artifacts, reports, and interfaces so technical and non-technical stakeholders can understand findings and apply them with confidence.',
      },
      {
        title: 'Ethical, responsible AI mindset',
        text: 'I evaluate bias, transparency, and impact when building solutions, aligning technical work with organizational and societal values.',
      },
    ],
  },
